...
The code committed to this **Public** repo is using **OpenSource** modules:
- MetaForce
- Nokogiri
- etc

So it seems *logical*/*fair* to share our work so others can *benefit* from it.
...
[*"Maybe International Can Wait"*](http://goo.gl/DpOyy) on PandoDaily...
